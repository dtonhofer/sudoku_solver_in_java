...
import sudoku.ValueCellBijectionConstraint.Type;
...
public class Constraints {
    ...
    /*
     * Check that "Board" is a solution according to all constraint.
     * Returns true if yes but throws if not.
     */

    public boolean fulfillsSolutionCriterium(Board board) {
        for (ValueCellBijectionConstraint cos : allConstraints) {
            cos.fulfillsSolutionCriterium(board);
        }
        return true;
    }
}